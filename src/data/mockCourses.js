...
export const COURSE_DETAILS = {
  "gce-alevel-physics-mechanics": {
    ...
    tutor: { name: "Mr. Fru Divine", verified: true, students: "3.2k" },
    likes: "980",
    description: [
  ...
  "gce-olevel-mathematics": {
    ...
    tutor: { name: "Mme. Ngo Bibiane", verified: true, students: "6.1k" },
    likes: "1540",
    description: [
  ...
  "olevel-chemistry-organic": {
    ...
    tutor: { name: "Dr. Ashu Tabe", verified: true, students: "2.4k" },
    likes: "610",
    description: [
  ...
  "english-language-composition": {
    ...
    tutor: { name: "Mrs. Enow Comfort", verified: true, students: "4.7k" },
    likes: "890",
    description: [
  ...
  "francais-grammaire-2nd": {
    ...
    tutor: { name: "M. Talla Joseph", verified: true, students: "1.1k" },
    likes: "405",
    description: [
  ...
  "literature-in-english-set-books": {
    ...
    tutor: { name: "Mr. Nkeng Solomon", verified: true, students: "1.8k" },
    likes: "322",
    description: [
  ...
  "history-cameroon-independence": {
    ...
    tutor: { name: "Mme. Atem Grace", verified: true, students: "950" },
    likes: "275",
    description: [
  ...
  "ict-computer-science-olevel": {
    ...
    tutor: { name: "Mr. Ebot Kingsley", verified: true, students: "3.9k" },
    likes: "1120",
    description: [
  ...
  "economics-alevel-basics": {
    ...
    tutor: { name: "Mr. Njoya Aboubakar", verified: true, students: "1.4k" },
    likes: "500",
    description: [
  ...
  "biology-olevel-human-systems": {
    ...
    tutor: { name: "Dr. Mballa Estelle", verified: true, students: "2.2k" },
    likes: "730",
    description: [
